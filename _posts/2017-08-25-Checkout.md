...
* **Response - Tela transacional** - É o Response retornado com dados para enviar o comprador para a tela transacional <br>
...
| Campo         | Tipo                  | Obrigatório | Tamanho | Descrição                                                                                                 |
|---------------|-----------------------|-------------|---------|-----------------------------------------------------------------------------------------------------------|
| `CheckoutUrl` | [Settings](#settings) | Sim         | 255     | URL da tela transacional. O Comprador **deve ser direcionado a esse ambiente para finalizar a transação** |
| `Profile`     | [Settings](#settings) | Sim         | 16      | Perfil do lojista: fixo “CheckoutCielo”.                                                                  |
| `Version`     | [Settings](#settings) | Sim         | 1       | Versão do serviço de criação de pedido (versão: 1).                                                       |
...
> Descontos podem ser enviados na API ou definidos no Backoffice. Acaso um Valor de desconto seja enviado na API, esse será o valor considerado, mesmo que o Backoffice possua outro valor registrado
