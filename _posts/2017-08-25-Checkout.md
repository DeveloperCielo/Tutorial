...
**Integração via Botão, QR CODE ou LINK** é um método de compra usada sempre que não houver um “carrinho de compras” em sua loja. Esse tipo de integração é realizada via o cadastro de um conjunto de itens a ser vendido on backoffice do Checkout Cielo.

Esse cadastro gera um 3 tipo diferentes de métodos de acesso a mesma tela transacional:
...
* Adicionando o botão (HTML) referente ao produto/serviço a ser comprado/pago. 
* Realizar
* Ou sempre que desejar disponibilizar uma venda rápida.
