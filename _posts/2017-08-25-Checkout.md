...
| `Customer.Address.Street`     |   Street: 70 (OBS 4)   | Ver comentário |
| `Customer.Address.Number`     |   Number: 10 (OBS 4)   | Ver comentário |
| `Customer.Address.Complement` | Complement: 20 (OBS 4) | Ver comentário |
| `Customer.Address.District`   |  District: 50 (OBS 4)  | Ver comentário |
...
|OBS 3: Caracteres válidos: <BR>Letras de A a Z (MAIÚSCULAS) <BR> Caracteres especiais de conjunção: hífen (-), apóstrofo ('). Quando utilizados, não pode conter espaços entre as letras; <BR><BR><BR> **Exemplos corretos**: D'EL-REI, D'ALCORTIVO, SANT'ANA.<BR><BR> **Exemplos incorretos**: D'EL - REI; até um espaço em branco entre palavras |
