...
|`Correios` | Utiliza a API dos correios para realizar o calculo do custo. O valor do calculo dependerá o contrato utilizado (Escolhido no Backoffice do checkout) e do tipo de integração para calculo: **Padrão** ou **Volumétrico** |

Abaixo, como cada opção é demonstrada na tela transacional

|FixedAmount|Free|WithoutShippingPickUp|WithoutShipping|Correios|
|-----------|----|---------------------|---------------|--------|
|![FixedAmount](http://fit-chair.cloudvent.net/Tutorial/public/images/Checkout/FixedAmount.PNG)|![Free](http://fit-chair.cloudvent.net/Tutorial/public/images/Checkout/Free.PNG)|![WithoutShippingPickUp](http://fit-chair.cloudvent.net/Tutorial/public/images/Checkout/WithoutShippingPickUp.PNG)|![WithoutShipping](http://fit-chair.cloudvent.net/Tutorial/public/images/Checkout/WithoutShippingPickUp.PNG)|![Correios](http://fit-chair.cloudvent.net/Tutorial/public/images/Checkout/Correios.PNG)|
...
| `Shipping.Package`            | Alphanumeric | Obrigatуrio | Inteiro | Tipo de pacote: <BR>`BOX`- Caixa <BR> `ROL` - Cilindro ou ENVELOPE                                           |                                                                 |
