...
| Propriedade                   |        Bradesco        |             BancoBanco do Brasil            |
|-------------------------------|:----------------------:|:-------------------------------------------:|
| `Provider`                    |        Bradesco2       |                BancoDoBrasil2               |
| `MerchantOrderId`             |       27 (OBS 1)       |                  50 (OBS 1)                 |
| `Payment.BoletoNumber`        |       11 (OBS 2)       |                  9 (OBS 2)                  |
| `Customer.Name`               |       34 (OBS 3)       |                  60 (OBS,3)                 |
| `Customer.Address.Street`     |   Street: 70 (OBS 4)   | Os campos devem totalizar até 60 caracteres |
| `Customer.Address.Number`     |   Number: 10 (OBS 4)   | Os campos devem totalizar até 60 caracteres |
| `Customer.Address.Complement` | Complement: 20 (OBS 4) | Os campos devem totalizar até 60 caracteres |
| `Customer.Address.District`   |  District: 50 (OBS 4)  | Os campos devem totalizar até 60 caracteres |
| `Customer.Address.City`       |       50 (OBS 4)       |                  18 (OBS 3)                 |
| `Payment.Instructions`        |           450          |                     450                     |
| `Payment.Demonstrative`       |           255          |            não é enviado ao banco           |

> **Banco Do Brasil**: Os campos `Customer.Address.Street`; `Customer.Address.Number`; `Customer.Address.Complement`; `Customer.Address.District` devem totalizar até 60 caracteres.



| Bradesco                                           |
|:--------------------------------------------------:|
| OBS 1: letras, números e caracteres como "_" e "$" | 
...
|OBS 3: são aceitos como caracteres válidos: as letras de A a Z (MAIÚSCULAS); caracteres especiais de conjunção: hífen (-), apóstrofo ('). Quando utilizados, não pode conter espaços entre as letras; <BR> **Exemplos corretos**: D'EL-REI, D'ALCORTIVO, SANT'ANA.<BR><BR> **Exemplos incorretos**: D'EL - REI; até um espaço em branco entre palavras |
