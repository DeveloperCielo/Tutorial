...
<aside class="warning">Caso um botão seja utilizado após a “Data final” cadastrada, a transação apresentará um erro exibindo **Oppss** na tela transacional. A Data pode ser editada na tela de edição do botão dentro de “Detalhes do Produto”</aside>
...
<aside class="notice">A regra da retentativa não pode ser modificada pelo lojista.</aside>
...
<aside class="warning">A Recorrência deve ser habilitada em sua Afiliação, do contrario,
...
A Recorrência é um processo de agendamento automático de transações de crédito, ou seja, é uma transação que se repetirá automaticamente, sem a necessidade do comprador acessar a tela transacional, de acordo com as regras definidas no momento do agendamento.
 ...
 as transações agendadas serão negadas. </aside>
