...
![Ativando Modo de teste](public/images/TM01.png)
...
![Tarja vermelha - Modo de teste](public/images/TM02.png)
...
Vai API, a tela transacional é "montada" com bases em dados enviados que formam um **Carrinho de compras**.
...
|-----------------------------|--------------|-------------|---------|-----------------------------------------------------------------------------------------|-------------|
| OrderNumber                 | Alphanumeric | Obrigatório | 64      | Número do pedido da loja.Não enviar caracter especial                                   | Condicional |
| SoftDescriptor              | Alphanumeric | Obrigatório | 13      | Texto para ser exibido na fatura do portador, após o nome do estabelecimento comercial  | Condicional |
| Cart.Discount.Type          | Tipo         | Obrigatório | Tamanho | Descrição                                                                               | Condicional |
| Cart.Discount.Value         | Tipo         | Obrigatório | Tamanho | Descrição                                                                               | Condicional |
| Cart.Items.Name             | Tipo         | Obrigatório | Tamanho | Descrição                                                                               | Condicional |
| Cart.Items.Description      | Tipo         | Obrigatório | Tamanho | Descrição                                                                               | Condicional |
| Cart.Items.UnitPrice        | Tipo         | Obrigatório | Tamanho | Descrição                                                                               | Condicional |
| Cart.Items.Quantity         | Tipo         | Obrigatório | Tamanho | Descrição                                                                               | Condicional |
| Cart.Items.Type             | Tipo         | Obrigatório | Tamanho | Descrição                                                                               | Condicional |
| Cart.Items.Sku              | Tipo         | Obrigatório | Tamanho | Descrição                                                                               | Condicional |
| Cart.Items.Weight           | Tipo         | Obrigatório | Tamanho | Descrição                                                                               | Condicional |
| Shipping.Type               | Tipo         | Obrigatório | Tamanho | Descrição                                                                               | Condicional |
| Shipping.SourceZipCode      | Tipo         | Obrigatório | Tamanho | Descrição                                                                               | Condicional |
| Shipping.TargetZipCode      | Tipo         | Obrigatório | Tamanho | Descrição                                                                               | Condicional |
| Shipping.Address.           | Tipo         | Obrigatório | Tamanho | Descrição                                                                               | Condicional |
| Shipping.Address.Street     | Tipo         | Obrigatório | Tamanho | Descrição                                                                               | Condicional |
| Shipping.Address.Number     | Tipo         | Obrigatório | Tamanho | Descrição                                                                               | Condicional |
| Shipping.Address.Complement | Tipo         | Obrigatório | Tamanho | Descrição                                                                               | Condicional |
| Shipping.Address.District   | Tipo         | Obrigatório | Tamanho | Descrição                                                                               | Condicional |
| Shipping.Address.City       | Tipo         | Obrigatório | Tamanho | Descrição                                                                               | Condicional |
| Shipping.Address.State      | Tipo         | Obrigatório | Tamanho | Descrição                                                                               | Condicional |
| Services.Name"              | Tipo         | Obrigatório | Tamanho | Descrição                                                                               | Condicional |
| Services.Price              | Tipo         | Obrigatório | Tamanho | Descrição                                                                               | Condicional |
| Services.Deadline           | Tipo         | Obrigatório | Tamanho | Descrição                                                                               | Condicional |
| Payment.BoletoDiscount      | Tipo         | Obrigatório | Tamanho | Descrição                                                                               | Condicional |
| Payment.DebitDiscount       | Tipo         | Obrigatório | Tamanho | Descrição                                                                               | Condicional |
| Customer.Identity           | Tipo         | Obrigatório | Tamanho | Descrição                                                                               | Condicional |
| Customer.FullName           | Tipo         | Obrigatório | Tamanho | Descrição                                                                               | Condicional |
| Customer.Email              | Tipo         | Obrigatório | Tamanho | Descrição                                                                               | Condicional |
| Customer.Phone              | Tipo         | Obrigatório | Tamanho | Descrição                                                                               | Condicional |
| Options.AntifraudEnabled    | Tipo         | Obrigatório | Tamanho | Descrição                                                                               | Condicional |
...
| Campo                       | Tipo         | Obrigatório | Tamanho | Descrição                                                                                               | Condicional                                                     |
|-----------------------------|--------------|-------------|---------|---------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------|
| OrderNumber                 | Alphanumeric | Opcional    | 64      | Nъmero do pedido da loja.                                                                               |                                                                 |
| SoftDescriptor              | Alphanumeric | Opcional    | 13      | Texto para ser exibido na fatura do portador, apуs o nome do estabelecimento comercial.                 |                                                                 |
| Cart.Discount.Type          | Alphanumeric | Condicional | 255     | Tipo do desconto a ser aplicado: "Amount", "Percent".                                                   | Obrigatуrio caso Cart.Discount.Value for maior ou igual a zero. |
| Cart.Discount.Value         | Numeric      | Condicional | 18      | Valor do desconto a ser aplicado (pode ser valor absoluto ou percentual).                               | Obrigatуrio caso Cart.Discount.Type for "Amount" ou "Percent".  |
| Cart.Items.Name             | Alphanumeric | Sim         | 128     | Nome do item no carrinho.                                                                               |                                                                 |
| Cart.Items.Description      | Alphanumeric | Opcional    | 256     | Descriзгo do item no carrinho.                                                                          |                                                                 |
| Cart.Items.UnitPrice        | Numeric      | Sim         | 18      | Preзo unitбrio do item no carrinho (em centavos. Ex: R$ 1,00 = 100).                                    |                                                                 |
| Cart.Items.Quantity         | Numeric      | Sim         | 9       | Quantidade do item no carrinho.                                                                         |                                                                 |
| Cart.Items.Type             | Alphanumeric | Sim         | 255     | Tipo do item no carrinho: "Asset", "Digital", "Service", "Payment".                                     |                                                                 |
| Cart.Items.Sku              | Alphanumeric | Opcional    | 32      | Sku do item no carrinho.                                                                                |                                                                 |
| Cart.Items.Weight           | Numeric      | Condicional | 9       | Peso em gramas do item no carrinho.                                                                     | Necessбrio caso Shipping.Type for "Correios".                   |
| Shipping.Type               | Alphanumeric | Sim         | 255     | Tipo do frete: "Correios", "FixedAmount", "Free", "WithoutShippingPickUp", "WithoutShipping".           |                                                                 |
| Shipping.SourceZipCode      | Numeric      | Condicional | 8       | CEP de origem do carrinho de compras.                                                                   | Obrigatуrio caso Shipping.Type for "Correios".                  |
| Shipping.TargetZipCode      | Numeric      | Opcional    | 8       | CEP do endereзo de entrega do comprador.                                                                |                                                                 |
| Shipping.Address.Street     | Alphanumeric | Sim         | 256     | Rua, avenida, travessa, etc, do endereзo de entrega do comprador.                                       |                                                                 |
| Shipping.Address.Number     | Alphanumeric | Sim         | 8       | Nъmero do endereзo de entrega do comprador.                                                             |                                                                 |
| Shipping.Address.Complement | Alphanumeric | Opcional    | 256     | Complemento do endereзo de entrega do comprador.                                                        |                                                                 |
| Shipping.Address.District   | Alphanumeric | Sim         | 64      | Bairro do endereзo de entrega do comprador.                                                             |                                                                 |
| Shipping.Address.City       | Alphanumeric | Sim         | 64      | Cidade do endereзo de entrega do comprador.                                                             |                                                                 |
| Shipping.Address.State      | Alphanumeric | Sim         | 2       | Estado (UF) do endereзo de entrega do comprador.                                                        |                                                                 |
| Shipping.Package            | Alphanumeric | Obrigatуrio | Inteiro | Tipo de pacote: BOX (Caixa), ROL (Cilindro) ou ENVELOPE                                                 |                                                                 |
| Shipping.Lenght             | Numeric      | Obrigatуrio | Inteiro | Comprimento do pacote                                                                                   |                                                                 |
| Shipping.Height             | Numeric      | Condicional | Inteiro | Altura do pacote enviado                                                                                | Obrigatуrio caso Shipping.Package como BOX                      |
| Shipping.Width              | Numeric      | Condicional | Inteiro | Largura do pacote.                                                                                      | Obrigatуrio caso Shipping.Package como BOX ou ENVELOPE          |
| Shipping.Diameter           | Numeric      | Condicional | Inteiro | Diвmetro do pacote.                                                                                     | Obrigatуrio caso Shipping.Package como ROL                      |
| Shipping.Services.Name      | Alphanumeric | Sim         | 128     | Nome do serviзo de frete.                                                                               |                                                                 |
| Shipping.Services.Price     | Numeric      | Sim         | 18      | Preзo do serviзo de frete (em centavos. Ex: R$ 1,00 = 100).                                             |                                                                 |
...
| Payment.DebitDiscount       | Numeric      | Condicional | 3       | Desconto, em porcentagem, para pagamentos a serem realizados com dйbito online.                         |                                                                 |
| FirstInstallmentDiscount    | Numeric      | Condicional | 3       | Desconto, em porcentagem, para pagamentos a serem realizados com crйdito a vista.                       |                                                                 |
| MaxNumberOfInstallments     | Numeric      | Condicional | 2       | Define valor mбximo de parcelas apresentadas no transacional                                            |                                                                 |
| Interval                    | Alphanumeric | Sim         |         | Intervalo entre cada transaзгo - Ver tabela 1.4A                                                        |                                                                 |
| EndDate                     | YYYY-MM-DD   | Nгo         | 255     | Se nгo enviado, a recorrкncia nгo se encerrarб automaticamente, ocorrendo sem prazo para ser encerrada. |                                                                 |
| Customer.Identity           | Numeric      | Condicional | 14      | CPF ou CNPJ do comprador.                                                                               |                                                                 |
| Customer.FullName           | Alphanumeric | Condicional | 288     | Nome completo do comprador.                                                                             |                                                                 |
| Customer.Email              | Alphanumeric | Condicional | 64      | Email do comprador.                                                                                     |                                                                 |
| Customer.Phone              | Numeric      | Condicional | 11      | Telefone do comprador.                                                                                  |                                                                 |
| Options.AntifraudEnabled    | Boolean      | Condicional | n/a     | Habilitar ou nгo a anбlise de fraude para o pedido: true ou false.                                      |                                                                 |
| ReturnUrl                   | Strin        | Condicional | 255     | Define para qual url o comprador serб enviado apуs finalizar a compra.                                  |                                                                 |
...
Todas as requisições enviadas para a Cielo deverão ser autenticadas pela loja. A autenticação consiste no envio do `MerchantID`, que é o identificador único da loja fornecido pela Cielo após a afiliação da loja. 
