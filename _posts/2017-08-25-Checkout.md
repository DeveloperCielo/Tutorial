...
|---------------|------------------|
|![Integração Via API](http://fit-chair.cloudvent.net/Tutorial/public/images/Checkout/IntAPI.png)|![Integração Via API](http://fit-chair.cloudvent.net/Tutorial/public/images/Checkout/IntAPI.png)|
