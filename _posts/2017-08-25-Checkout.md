...
| Propriedade                   |Observações|        Bradesco        |             BancoBanco do Brasil            |
|-------------------------------||:----------------------:|:-------------------------------------------:|
| `Provider`                    ||        Bradesco2       |                BancoDoBrasil2               |
| `MerchantOrderId`             |OBS 1|       27        |                  50 (OBS 1)                 |
| `Payment.BoletoNumber`        |OBS 2|       11 (OBS 2)       |                  9 (OBS 2)                  |
| `Customer.Name`               |OBS 3|       34 (OBS 3)       |                  60 (OBS,3)                 |
| `Customer.Address.Street`     |OBS 4|   Street: 70 (OBS 4)   | Ver comentário |
| `Customer.Address.Number`     |OBS 4|   Number: 10 (OBS 4)   | Ver comentário |
| `Customer.Address.Complement` |OBS 4| Complement: 20 (OBS 4) | Ver comentário |
| `Customer.Address.District`   |OBS 4|  District: 50 (OBS 4)  | Ver comentário |
| `Customer.Address.City`       |OBS 4|       50 (OBS 4)       |                  18 (OBS 3)                 |
