...
Abaixo é descrito todos os campos retornados, assim como suas definições e tamanhos:
...
| `payment_boletonumber`         | Numero do boleto gerado                                                                                      | String        | 1              | 1              |
...
| `test_transaction`             | Indica se a transação foi gerada com o `Modo de teste` ativado                                               | Boolean       | 1              | 32             |


**Payment_status** 

> O Checkout possui um
