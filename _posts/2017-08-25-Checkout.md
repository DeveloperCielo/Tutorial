...
| ReturnUrl                   | Strin        | Condicional | 255     | Define para qual url o comprador será enviado após finalizar a compra.                                  |                                                                 |
...
| RecurrentPayment.Interval                    | Alphanumeric | Sim         |         | Intervalo entre cada transação da recorrencia - Ver Recorrencia Programada                              |                                                                 |
| RecurrentPayment.EndDate                     | YYYY-MM-DD   | Nгo         | 255     | Data onde a Recorrência se encerrará; Se não enviado a recorrencia se encerra somente se cancelada      |                                                                 |
