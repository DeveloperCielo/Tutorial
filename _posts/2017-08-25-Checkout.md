...
# Criando transações Checkout Cielo
...
| Campo         | Tipo                  | Obrigatório | Tamanho | Descrição                                                                                                 |
|---------------|-----------------------|-------------|---------|-----------------------------------------------------------------------------------------------------------|
| `CheckoutUrl` | [Settings](#settings) | Sim         | n/a     | URL da tela transacional. O Comprador **deve ser direcionado a esse ambiente para finalizar a transação** |
| `Profile`     | [Settings](#settings) | Sim         | n/a     | Tipo de produto Cielo utilizado. Sempre será Checkout Cielo                                               |
| `Version`     | [Settings](#settings) | Sim         | n/a     | Versão da tela transacional utilizada                                                                     |
